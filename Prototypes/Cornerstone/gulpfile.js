...
gulp.task('copy', ['copy:html', 'copy:images', 'copy:fonts', 'copy:data', 'copy:html:root']);
...
gulp.task('copy:data', function () {
	...
	gulp.src([SETTINGS.src.data + '*', SETTINGS.src.data + '**/*'])
		.pipe(gulp.dest(SETTINGS.build.data));
});
...
gulp.task('watch', function () {
	...
	watchedFiles.push(gulp.watch([SETTINGS.src.data + '*.*',  SETTINGS.src.data + '**/*.*'],  ['copy:data']));
